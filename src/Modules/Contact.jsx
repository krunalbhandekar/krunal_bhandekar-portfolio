      ...
      >
        ...
        <div className="mt-3 mb-3 pr-lg-5 pr-xs-3">
          ...
          <Button
            ...
            onClick={() =>
              window.open("https://www.linkedin.com/in/krunal-bhandekar", "_blank")
            }
          >
          ...
          <Button
            className="contact-btns bg-customBlue mr-2 shadow border-0 py-1"
            onClick={() =>
              window.open("https://github.com/krunalbhandekar", "_blank")
            }
          >
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                'mailto:krunalbhandekar10@gmail.com?subject="Hello !"',
                "_blank"
              )
            }
          >
